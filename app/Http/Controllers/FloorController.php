...
class FloorController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('content.floors.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate(['name' => 'bail|required|unique:floors,name,NULL,id,place_id,'.$request->place_id, 'place_id' => 'required', 'level' => 'required', 'remarks' => 'bail|nullable|min:3']);
    ...
    {
        $validated = $request->validate(['name' => 'bail|required|unique:floors,name,'.$floor->id.',id,place_id,'.$request->place_id, 'level' => 'required', 'place_id' => 'required', 'remarks' => 'bail|nullable|min:3']);
