        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ __('application.floor.create_new') }}
                    <a class="btn btn-sm btn-info pull-right" href="{{ route('floors.index') }}">{{
                        __('application.floor.floor_list') }}</a>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name" class="text-md-right">{{ __('application.floor.name') }} <span
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="level" class="text-md-right">{{ __('application.floor.floor_level')
                                        }}</label>
                                    <select name="level" id="level"
                                        class="form-control{{ $errors->has('level') ? ' is-invalid' : '' }}" required>
                                        @for ($i = 0; $i <= 12; $i++ ) <option value="{{ $i }}" {{ (old('level')==$i )
                                            ? ' selected' : '' }}>{{ $i }}</option>
                                            @endfor
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name" class="text-md-right">{{ __('application.floor.remarks')
                                        }}</label>
