@extends('layouts.app')
@section('title', ' - '.__('application.rfid_vehicles.edit'))
@section('content')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ __('application.rfid_vehicles.edit') }}
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('parking_settings.rfid_vehicles.update',['rfidVehicle' => $rfidVehicle->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="place_id" id="place_id" required
                                        ...
                                        <option value="{{ $place->id }}" {{ old('place_id',$rfidVehicle->category->place_id)==$place->id ? ' selected' :
                                            '' }}>
                                            {{ $place->name }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" required
                                        ...
                                        <option data-place-id="{{$category->place_id}}" value="{{ $category->id }}" {{ old('category_id',$rfidVehicle->category_id)==$category->id ? ' selected' :
                                            '' }}>
                                            {{ $category->type }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required
                                        ...
                                        value="{{ old('vehicle_no',$rfidVehicle->vehicle_no) }}" name="vehicle_no">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required
                                        ...
                                        value="{{ old('rfid_no',$rfidVehicle->rfid_no) }}" name="rfid_no">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="driver_name" class="text-md-right">{{ __('application.rfid_vehicles.driver_name') }}</label>
                                    <input type="text" required
                                        class="form-control{{ $errors->has('driver_name') ? ' is-invalid' : '' }}"
                                        value="{{ old('driver_name',$rfidVehicle->driver_name) }}" name="driver_name">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="driver_mobile" class="text-md-right">{{ __('application.rfid_vehicles.driver_mobile') }}</label>
                                    <input type="text" required
                                        class="form-control{{ $errors->has('driver_mobile') ? ' is-invalid' : '' }}"
                                        value="{{ old('driver_mobile',$rfidVehicle->driver_mobile) }}" name="driver_mobile">
                            ...
                            <div class="col-12">
                                <div class="pull-right d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        {{ __('application.rfid_vehicles.update') }}
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(window).on("load",function(){
        ...
        $('#category_id').val({{$rfidVehicle->category_id}});
    });
