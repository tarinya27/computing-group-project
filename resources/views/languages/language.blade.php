                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input placeholder="Language Name" id="name" type="text"
                                        ...
                                        name="name" value="{{ $language->name }}" autocomplete="off" required>
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input placeholder="Language Code" id="code" type="text"
                                        ...
                                        name="code" value="{{ $language->code }}" autocomplete="off" required>
                                    @if ($errors->has('code'))
                                        <span class="invalid-feedback" role="alert">
                                        ...
                                        <select name="country_id" required id="country_id"
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    {{ $language->country_id == $country->id ? ' selected' : '' }}>
                                                    {{ $country->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="status" required id="status"
                                            ...
                                            <option value="0"
                                                {{ old('status', $language->status) == 0 ? ' selected' : '' }}>
                                                {{ __('application.language.deactivated') }}
                                            </option>
                                            <option value="1"
                                                {{ old('status', $language->status) == 1 ? ' selected' : '' }}>
                                                {{ __('application.language.active') }}
                                            </option>
                                            <option value="2"
                                                {{ old('status', $language->status) == 2 ? ' selected' : '' }}>
